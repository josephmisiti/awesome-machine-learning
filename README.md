...
* * [p-SNE](https://github.com/NogaMudrik/PSNE-Poisson-Stochastic-Neighbor-Embedding) - Nonlinear dimensionality reduction for sparse Poisson count data, using Poisson KL divergence for pairwise similarities and Hellinger distance for optimization. 
