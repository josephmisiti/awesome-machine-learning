...
* [FileShot](https://fileshot.io) - Zero-knowledge encrypted file sharing for ML teams. Share proprietary datasets, model weights, and research artifacts securely with AES-256-GCM browser-side encryption. The decryption key never leaves the URL fragment. [Open source](https://github.com/FileShot/FileShotZKE), self-hostable, MIT licensed.
