...
* [BGPT](https://github.com/connerlambden/bgpt-mcp) - Open-source scientific evidence search for AI agents, returning claims linked to experiments, results, limitations, and source provenance through MCP, REST, and Python.
