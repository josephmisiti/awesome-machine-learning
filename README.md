...
* [WFGY ProblemMap](https://github.com/onestardao/WFGY) - MIT-licensed semantic firewall and 16-problem RAG / LLM pipeline failure map for debugging retrieval, ranking, and guardrails.
