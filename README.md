...
* [Meme Search](https://github.com/neonwatty/meme-search) - Open source meme search engine using vision-language models for semantic image search, built to self-host with Python and Docker.
