...
* [Tessera](https://github.com/tessera-ops/tessera) - OWASP-aligned AI security testing framework. 42 automated tests across 5 categories (Model, Application, Infrastructure, Data Governance, Agentic AI) for GPT-4o, Llama, Mistral, and any AI model. First framework with complete OWASP Agentic AI Top 10 coverage.
