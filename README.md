...
* [Potato](https://github.com/davidjurgens/potato) - Portable annotation tool supporting classification, span, coreference, entity linking, and agent trace evaluation with AI-assisted labeling, quality control, and 300+ clonable example tasks.
